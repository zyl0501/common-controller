package com.ray.widget.flowlayout;
...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {  
        ...
        for (int i = 0; i < count; i++) {  
            ...
            child.measure(  
//                    MeasureSpec.makeMeasureSpec(sizeWidth, modeWidth == MeasureSpec.EXACTLY ? modeWidth : MeasureSpec.AT_MOST),
//                    MeasureSpec.makeMeasureSpec(sizeHeight, modeHeight == MeasureSpec.EXACTLY ? modeHeight : MeasureSpec.AT_MOST)
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        ...
        try {  
            horizontalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_horizontalSpacing, horizontalSpacing);  
            verticalSpacing = a.getDimensionPixelSize(R.styleable.FlowLayout_verticalSpacing, verticalSpacing);
            orientation = a.getInteger(R.styleable.FlowLayout_flOrientation, HORIZONTAL);
