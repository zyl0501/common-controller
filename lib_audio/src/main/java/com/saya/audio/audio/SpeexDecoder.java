...
public class SpeexDecoder {
    ...
    public void decode(AudioPlayListener listener) throws Exception {
                ...
                for (curseg = 0; curseg < segments; curseg++) {
                    ...
                    if (packetNo == 0) {
                        ...
                        if ((decsize = speexDecoder.decode(payload, decoded,
                            ...
                            track.play();
                            if(curseg == 0 && listener != null) listener.onStart();
                        }
                        packetNo++;
                    }
                }
                if (chksum != origchksum) {
                    IOException e = new IOException("Ogg CheckSums do not match");
                    if(listener != null)
                    listener.onError(e);
                    throw e;
                }
