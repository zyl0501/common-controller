...
import com.saya.audio.util.Logger;
...
public class AudioPlayerHandler{
    ...
    public void startPlay(String filePath) {
        ...
        try {
            ...
            RecordPlayThread rpt = new RecordPlayThread(new AudioPlayListener() {
                @Override
                public void onStop() {
    ...
    class RecordPlayThread extends Thread {
        ...
        public RecordPlayThread(AudioPlayListener listener) {
            super();
