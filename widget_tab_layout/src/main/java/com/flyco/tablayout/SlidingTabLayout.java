...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private float mIndicatorPaddingTextWidth;               //超出Text的边缘部分
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorPaddingTextWidth = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_padding_text_width, dp2px(0));
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    private void calcIndicatorRect() {
        ...
        if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
            ...
            margin = (right - left - textWidth) / 2 - mIndicatorPaddingTextWidth;
        }
        ...
        if (this.mCurrentTab < mTabCount - 1) {
            ...
            left = left + mCurrentPositionOffset * (nextTabLeft - left) - mIndicatorPaddingTextWidth;
            right = right + mCurrentPositionOffset * (nextTabRight - right) + mIndicatorPaddingTextWidth;
