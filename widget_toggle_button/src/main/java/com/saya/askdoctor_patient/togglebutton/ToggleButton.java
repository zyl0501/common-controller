...
import com.saya.askdoctor_patient.R;
import com.saya.askdoctor_patient.facebook.rebound.SimpleSpringListener;
import com.saya.askdoctor_patient.facebook.rebound.Spring;
import com.saya.askdoctor_patient.facebook.rebound.SpringConfig;
import com.saya.askdoctor_patient.facebook.rebound.SpringSystem;
import com.saya.askdoctor_patient.facebook.rebound.SpringUtil;
...
public class ToggleButton extends View {
  ...
  public void setup(AttributeSet attrs) {
    ...
    TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.wtb_ToggleButton);
    offBorderColor = typedArray.getColor(R.styleable.wtb_ToggleButton_wtb_offBorderColor, offBorderColor);
    onColor = typedArray.getColor(R.styleable.wtb_ToggleButton_wtb_onColor, onColor);
    spotColor = typedArray.getColor(R.styleable.wtb_ToggleButton_wtb_spotColor, spotColor);
    offColor = typedArray.getColor(R.styleable.wtb_ToggleButton_wtb_offColor, offColor);
    borderWidth = typedArray.getDimensionPixelSize(R.styleable.wtb_ToggleButton_wtb_borderWidth, borderWidth);
    defaultAnimate = typedArray.getBoolean(R.styleable.wtb_ToggleButton_wtb_animate, defaultAnimate);
    isDefaultOn = typedArray.getBoolean(R.styleable.wtb_ToggleButton_wtb_isDefaultOn, isDefaultOn);
    typedArray.recycle();
