package com.example.rightindexbar.IndexBar.widget;
...
import com.example.rightindexbar.IndexBar.bean.BaseIndexPinyinBean;
import com.example.rightindexbar.R;
...
public class IndexBar extends View {
    private static final String TAG = "syy/RightIndexBar";
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor  = Color.BLACK;//默认字体是纯黑色
    ...
    private void initSourceDatas() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            // 如果不是top 才转拼音，否则不用转了
            if (indexPinyinBean.getTarget() != null){
