...
public class AsyncTask<Result> extends AbstractTask<Result> {
     ...
     * @return
     */
    public AsyncTask<Result> taskName(@NonNull String taskName) {
     ...
     * @return
     */
    public AsyncTask<Result> groupName(@NonNull String groupName) {
    ...
    public static <Result> AsyncTask<Result> build(Callable callable, ITaskCallback<Result> callback) {
