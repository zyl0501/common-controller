...
public class ImageFolderAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.pk_adapter_folder_list_item, parent, false);
        ...
        holder.imageCount.setText(mActivity.getString(R.string.pk_folder_image_count, folder.images.size()));
