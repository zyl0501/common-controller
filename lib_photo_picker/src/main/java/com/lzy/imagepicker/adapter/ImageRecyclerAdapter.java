...
public class ImageRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_CAMERA){
            return new CameraViewHolder(mInflater.inflate(R.layout.pk_adapter_camera_item,parent,false));
        }
        return new ImageViewHolder(mInflater.inflate(R.layout.pk_adapter_image_list_item,parent,false));
    }
