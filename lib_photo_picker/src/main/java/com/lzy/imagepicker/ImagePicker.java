...
public class ImagePicker {
    ...
    public static final String WHO_START_WITH = "who_start_with";
    ...
    private boolean mDirectTakePicture = false;
    ...
    public boolean isDirectTakePicture() {
        return mDirectTakePicture;
    }

    public void setDirectTakePicture(boolean directTakePicture) {
        this.mDirectTakePicture = directTakePicture;
    }
