...
public class ImagePreviewActivity extends ImagePreviewBaseActivity implements ImagePicker.OnImageSelectedListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCbOrigin.setText(getString(R.string.pk_origin));
        ...
        mCbCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCbCheck.isChecked() && selectedImages.size() >= selectLimit) {
                    Toast.makeText(ImagePreviewActivity.this, ImagePreviewActivity.this.getString(R.string.pk_select_limit, selectLimit), Toast.LENGTH_SHORT).show();
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        if (imagePicker.getSelectImageCount() > 0) {
            mBtnOk.setText(getString(R.string.pk_select_complete, imagePicker.getSelectImageCount(), imagePicker.getSelectLimit()));
            mBtnOk.setEnabled(true);
        } else {
            mBtnOk.setText(getString(R.string.pk_complete));
        ...
        if (mCbOrigin.isChecked()) {
            ...
            mCbOrigin.setText(getString(R.string.pk_origin_size, fileSize));
        }
    }
    ...
    public void onImageSingleTap() {
        if (topBar.getVisibility() == View.VISIBLE) {
            topBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.pk_top_out));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.pk_fade_out));
...
//            if (Build.VERSION.SDK_INT >= 16) content.setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN);
            ...
            topBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.pk_top_in));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(this, R.anim.pk_fade_in));
            topBar.setVisibility(View.VISIBLE);
            bottomBar.setVisibility(View.VISIBLE);
            tintManager.setStatusBarTintResource(R.color.pk_status_bar);//通知栏所需颜色
