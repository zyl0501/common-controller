...
public class DialogHelp {
    ...
    public static AlertDialog.Builder getSelfViewDialog(Context context, View view) {
        AlertDialog.Builder builder = getDialog(context);
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context,
        ...
        builder.setPositiveButton(positiviStr, onClickListener);
        builder.setNegativeButton(negativiStr, onClickListener);
        return builder;
    }
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context, String message, DialogInterface.OnClickListener onOkClickListener, DialogInterface.OnClickListener onCancleClickListener, int positiveRes, int cancelRes) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setMessage(message);
        builder.setPositiveButton(positiveRes, onOkClickListener);
        builder.setNegativeButton(cancelRes, onCancleClickListener);
        return builder;
    }
